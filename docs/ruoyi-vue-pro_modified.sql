...
COMMENT
ON COLUMN yudao_demo01_contact.id IS '编号';
COMMENT
ON COLUMN yudao_demo01_contact.name IS '名字';
COMMENT
ON COLUMN yudao_demo01_contact.sex IS '性别';
COMMENT
ON COLUMN yudao_demo01_contact.birthday IS '出生年';
COMMENT
ON COLUMN yudao_demo01_contact.description IS '简介';
COMMENT
ON COLUMN yudao_demo01_contact.avatar IS '头像';
COMMENT
ON COLUMN yudao_demo01_contact.creator IS '创建者';
COMMENT
ON COLUMN yudao_demo01_contact.create_time IS '创建时间';
COMMENT
ON COLUMN yudao_demo01_contact.updater IS '更新者';
COMMENT
ON COLUMN yudao_demo01_contact.update_time IS '更新时间';
COMMENT
ON COLUMN yudao_demo01_contact.deleted IS '是否删除';
COMMENT
ON COLUMN yudao_demo01_contact.tenant_id IS '租户编号';
COMMENT
ON TABLE yudao_demo01_contact IS '示例联系人表';
...
COMMENT
ON COLUMN yudao_demo02_category.id IS '编号';
COMMENT
ON COLUMN yudao_demo02_category.name IS '名字';
COMMENT
ON COLUMN yudao_demo02_category.parent_id IS '父级编号';
COMMENT
ON COLUMN yudao_demo02_category.creator IS '创建者';
COMMENT
ON COLUMN yudao_demo02_category.create_time IS '创建时间';
COMMENT
ON COLUMN yudao_demo02_category.updater IS '更新者';
COMMENT
ON COLUMN yudao_demo02_category.update_time IS '更新时间';
COMMENT
ON COLUMN yudao_demo02_category.deleted IS '是否删除';
COMMENT
ON COLUMN yudao_demo02_category.tenant_id IS '租户编号';
COMMENT
ON TABLE yudao_demo02_category IS '示例分类表';
...
COMMENT
ON COLUMN yudao_demo03_course.id IS '编号';
COMMENT
ON COLUMN yudao_demo03_course.student_id IS '学生编号';
COMMENT
ON COLUMN yudao_demo03_course.name IS '名字';
COMMENT
ON COLUMN yudao_demo03_course.score IS '分数';
COMMENT
ON COLUMN yudao_demo03_course.creator IS '创建者';
COMMENT
ON COLUMN yudao_demo03_course.create_time IS '创建时间';
COMMENT
ON COLUMN yudao_demo03_course.updater IS '更新者';
COMMENT
ON COLUMN yudao_demo03_course.update_time IS '更新时间';
COMMENT
ON COLUMN yudao_demo03_course.deleted IS '是否删除';
COMMENT
ON COLUMN yudao_demo03_course.tenant_id IS '租户编号';
COMMENT
ON TABLE yudao_demo03_course IS '学生课程表';
...
COMMENT
ON COLUMN yudao_demo03_grade.id IS '编号';
COMMENT
ON COLUMN yudao_demo03_grade.student_id IS '学生编号';
COMMENT
ON COLUMN yudao_demo03_grade.name IS '名字';
COMMENT
ON COLUMN yudao_demo03_grade.teacher IS '班主任';
COMMENT
ON COLUMN yudao_demo03_grade.creator IS '创建者';
COMMENT
ON COLUMN yudao_demo03_grade.create_time IS '创建时间';
COMMENT
ON COLUMN yudao_demo03_grade.updater IS '更新者';
COMMENT
ON COLUMN yudao_demo03_grade.update_time IS '更新时间';
COMMENT
ON COLUMN yudao_demo03_grade.deleted IS '是否删除';
COMMENT
ON COLUMN yudao_demo03_grade.tenant_id IS '租户编号';
COMMENT
ON TABLE yudao_demo03_grade IS '学生班级表';
...
COMMENT
ON COLUMN yudao_demo03_student.id IS '编号';
COMMENT
ON COLUMN yudao_demo03_student.name IS '名字';
COMMENT
ON COLUMN yudao_demo03_student.sex IS '性别';
COMMENT
ON COLUMN yudao_demo03_student.birthday IS '出生日期';
COMMENT
ON COLUMN yudao_demo03_student.description IS '简介';
COMMENT
ON COLUMN yudao_demo03_student.creator IS '创建者';
COMMENT
ON COLUMN yudao_demo03_student.create_time IS '创建时间';
COMMENT
ON COLUMN yudao_demo03_student.updater IS '更新者';
COMMENT
ON COLUMN yudao_demo03_student.update_time IS '更新时间';
COMMENT
ON COLUMN yudao_demo03_student.deleted IS '是否删除';
COMMENT
ON COLUMN yudao_demo03_student.tenant_id IS '租户编号';
COMMENT
ON TABLE yudao_demo03_student IS '学生表';
